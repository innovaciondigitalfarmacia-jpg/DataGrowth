...
export default async function handler(req, res) {
  ...
  const BASE_URL = process.env.VERCEL_URL ? 'https://' + process.env.VERCEL_URL : 'https://datagrowthagency.com';
  ...
  if (req.method === 'POST') {
    const { ig_token, ig_user_id, image_base64, image_url, caption } = req.body;
